...
public class JakartaInvoiceProcessApplication extends JakartaServletProcessApplication {

  private static final Logger LOGGER = Logger.getLogger(JakartaInvoiceProcessApplication.class.getName());
  ...
  private void startProcessInstances(ProcessEngine processEngine, String processDefinitionKey, Integer version) {
    ...
    InputStream invoiceInputStream = JakartaInvoiceProcessApplication.class.getClassLoader().getResourceAsStream("invoice.pdf");
    ...
    if (numberOfRunningProcessInstances == 0) { // start three process instances
      ...
      invoiceInputStream = JakartaInvoiceProcessApplication.class.getClassLoader().getResourceAsStream("invoice.pdf");
